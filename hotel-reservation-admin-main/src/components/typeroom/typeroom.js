...
import TypeRoomModal from "./typeRoomModal";
...
class TypeRoom extends Component {
    ...
    handleSubmit = (item) => {
        ...
        if (item.id) {
            axios
                .put(`${server}apps/type-room/update/${item.id}/`, item)
                .then((res) => this.refreshList());
            return;
        }
        else {
            axios
                .post(`${server}apps/type-room/create/`, item)
                .then((res) => this.refreshList());
        }
    };
    ...
    handleDelete = (item) => {
        axios
            .delete(`${server}apps/type-room/destroy/${item.id}/`)
            .then((res) => this.refreshList());
    };
